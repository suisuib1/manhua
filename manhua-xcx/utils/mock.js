const pageRoutes = {
  ...
  diary: '/subpackage/packageA/pages/diary/diary',
  character: '/subpackage/packageA/pages/character/character',
  generating: '/subpackage/packageA/pages/generating/generating',
  chapterDetail: '/subpackage/packageA/pages/chapter-detail/chapter-detail',
  comicBook: '/subpackage/packageA/pages/comic-book/comic-book',
  continuousChapter: '/subpackage/packageA/pages/continuous-chapter/continuous-chapter',
  share: '/subpackage/packageA/pages/share/share',
  mine: '/pages/mine/mine',
  quotaEmpty: '/subpackage/packageA/pages/quota-empty/quota-empty',
  privacy: '/subpackage/packageA/pages/privacy/privacy',
  about: '/subpackage/packageA/pages/about/about',
  settings: '/subpackage/packageA/pages/settings/settings',
}

const storageKeys = {
  generatedComicChapters: 'generatedComicChapters',
  draftComicChapter: 'draftComicChapter',
  createDraftResetAfterGeneration: 'createDraftResetAfterGeneration',
